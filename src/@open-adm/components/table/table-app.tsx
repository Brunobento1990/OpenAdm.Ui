              ...
              <TableCell
                ...
                onClick={() => {
                  if (column.sortable && props.setSorting) {
                    props.setSorting({
                      field: column.field,
                      sort: props.sorting?.field === column.field && props.sorting?.sort === 'asc' ? 'desc' : 'asc'
                    })
                  }
                }}
              >
                ...
                {column.sortable && (
                  <TableSortLabel
                    ...
                    direction={props.sorting?.field === column.field ? props.sorting?.sort : 'asc'}
                  />
                )}
              </TableCell>
            ))}
            ...
            <Fragment key={index}>
              <TableRow
                ...
                sx={{
                  ...
                  animation: `${opacityAnimation} ${index < 10 ? `0.${index}` : `1.${index}`}s linear alternate`,
                  '&:hover': {
                    backgroundColor: '#f7faff'
                  },
                  borderBottom: '1px solid #f7faff',
                  backgroundColor: props.getBackgroundColor ? props.getBackgroundColor(row) : undefined
                }}
              >
