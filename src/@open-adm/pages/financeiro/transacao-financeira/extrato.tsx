...
export function Extrato() {
  ...
  return (
    <FormApp loading={loading} submit={form.onSubmit} titulo='Extrato por período' tituloBotaoSalvar='Carregar'>
      <FormRow spacing={3}>
          ...
          columns={[
            {
              ...
              renderCell: (row: ITransacaoFinanceira) => {
                return (
                  <IconifyIcon
                    icon={row.tipoTransacaoFinanceira === 0 ? listaIcones.contasAReceber : listaIcones.contasAPagar}
            ...
            },
            {
              ...
              renderCell: (row: ITransacaoFinanceira) => {
                ...
                return <StatusApp cor={status.color} titulo={status.title} />
              }
            },
            {
              width: 50,
            ...
            },
            {
              ...
              headerName: 'Pedido',
              renderCell: (row: ITransacaoFinanceira) =>
                row.parcela?.fatura?.pedido?.numero ? `#${row.parcela?.fatura?.pedido?.numero}` : ''
            }
          ]}
          rows={transacoes}
        />
