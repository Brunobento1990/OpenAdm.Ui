...
export function PosicaoEstoqueForm() {
  ...
  const form = useFormikAdapter<IPosicaoEstoqueUpdate>({
    ...
    validationSchema: new YupAdapter().string('produtoId').build(),
    onSubmit: submit
  })
    ...
    >
      <FormRoot.FormRow spacing={3}>
        <FormRoot.FormItemRow xs={12} sm={6}>
          <InputApp label='Produto' id='produto' value={form.values.produto} required readonly />
        </FormRoot.FormItemRow>
        <FormRoot.FormItemRow xs={12} sm={3}>
          <InputApp label='Peso' id='peso' value={form.values.peso} required readonly />
        </FormRoot.FormItemRow>
        <FormRoot.FormItemRow xs={12} sm={3}>
          <InputApp label='Tamanho' id='tamanho' value={form.values.tamanho} required readonly />
        </FormRoot.FormItemRow>
        <FormRoot.FormItemRow xs={12} sm={3}>
          <InputApp
            label='Quantidade'
