    ...
    },
    {
      ...
      cellRenderer: (params: { data: any }) => (
        <Tooltip title='Inativar' placement='top'>
          <IconButton onClick={() => props.inativarEcommerce(params.data.id, params.data.inativoEcommerce ?? false)}>
...
export const schema = yup.object().shape({
  descricao: yup.string().max(255, 'Campo máximo exedido!').required('Informe a descrição!'),
  categoriaId: yup.string().required('Informe a categoria!')
})
