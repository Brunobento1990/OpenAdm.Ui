...
import {
  IRelatorioPosicaoEstoqueRequest,
  IRelatorioPosicaoEstoqueResponse
} from 'src/@open-adm/types/relatorio-posicao-estoque'
        ...
        children: (
          <BoxApp>
            <ButtonApp
              ...
              title='Imprimir'
              variant='outlined'
              disabled={!resultado || !resultado.itens || resultado.itens.length === 0}
            />
          </BoxApp>
        )
      }}
