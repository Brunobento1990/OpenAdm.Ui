...
export function RelatorioProducao() {
  ...
  return (
    <FormRoot.Form submit={submit} titulo='Relatório de produção' tituloBotaoSalvar='Download' loading={loading}>
      ...
      {form.values.pedidosIds?.length > 0 && (
        <Box>
          ...
          <Typography>
            Valor total: {formatMoney(form.values.pedidosIds.reduce((a, b) => a + b.valorTotal, 0))}
          </Typography>
        </Box>
      )}
    </FormRoot.Form>
